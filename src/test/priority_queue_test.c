...
// Expected results
const void *_keys        [] = {(void*) 0};
const void *G_keys       [] = {(void*) 7, (void*) 0};
const void *DG_keys      [] = {(void*) 4, (void*) 7, (void*) 0};
const void *AD_keys      [] = {(void*) 1, (void*) 4, (void*) 0};
const void *ABCDEFG_keys [] = {(void*) 1, (void*) 2, (void*) 3, (void*) 4, (void*) 5, (void*) 6, (void*) 7, (void*) 0};
...
int test_one_element_priority_queue  ( int (*priority_queue_constructor)(priority_queue **), const char *name, const void **keys );
int test_two_element_priority_queue  ( int (*priority_queue_constructor)(priority_queue **), const char *name, const void **keys );
int test_seven_element_priority_queue( int (*priority_queue_constructor)(priority_queue **), const char *name, const void **keys );
...
int test_one_element_priority_queue(int (*priority_queue_constructor)(priority_queue **pp_priority_queue), const char *name, const void **keys)
{
...
int test_two_element_priority_queue(int (*priority_queue_constructor)(priority_queue **pp_priority_queue), const char *name, const void **keys)
{
...
int test_seven_element_priority_queue(int (*priority_queue_constructor)(priority_queue **pp_priority_queue), const char *name, const void **keys)
{
...
bool test_dequeue(int (*priority_queue_constructor)(priority_queue **pp_priority_queue), void *value, size_t how_many, result_t expected)
{
    ...
    // Check for a match
    if ( result != zero ) if ( value == (uintptr_t)p_value ) result = match;
