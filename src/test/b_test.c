...
// Test helpers
bool test_insert ( void (*constructor)(b_tree **), void *value, result_t expected );
bool test_search ( void (*constructor)(b_tree **), void *key, void *expected_value, result_t expected );
bool test_remove ( void (*constructor)(b_tree **), void *key, void *expected_value, result_t expected );
bool test_size_non_zero ( void (*constructor)(b_tree **), result_t expected );
bool test_size ( void (*constructor)(b_tree **), size_t expected_count, result_t expected );

// Constructor functions
void construct_empty ( b_tree **pp_b_tree );
void construct_A ( b_tree **pp_b_tree );
void construct_B ( b_tree **pp_b_tree );
void construct_C ( b_tree **pp_b_tree );
void construct_D ( b_tree **pp_b_tree );
void construct_AB ( b_tree **pp_b_tree );
void construct_AC ( b_tree **pp_b_tree );
void construct_BC ( b_tree **pp_b_tree );
void construct_BA ( b_tree **pp_b_tree );
void construct_CA ( b_tree **pp_b_tree );
void construct_CB ( b_tree **pp_b_tree );
void construct_ABC ( b_tree **pp_b_tree );
void construct_ACB ( b_tree **pp_b_tree );
void construct_BAC ( b_tree **pp_b_tree );
void construct_BCA ( b_tree **pp_b_tree );
void construct_CAB ( b_tree **pp_b_tree );
void construct_CBA ( b_tree **pp_b_tree );
void construct_ABCD ( b_tree **pp_b_tree );

// Removal constructors
void construct_A_remove_A_empty ( b_tree **pp_b_tree );
void construct_B_remove_B_empty ( b_tree **pp_b_tree );
void construct_C_remove_C_empty ( b_tree **pp_b_tree );
void construct_AB_remove_A_B ( b_tree **pp_b_tree );
void construct_AB_remove_B_A ( b_tree **pp_b_tree );
void construct_AC_remove_A_C ( b_tree **pp_b_tree );
void construct_AC_remove_C_A ( b_tree **pp_b_tree );
void construct_BC_remove_B_C ( b_tree **pp_b_tree );
void construct_BC_remove_C_B ( b_tree **pp_b_tree );
void construct_ABC_remove_A_BC ( b_tree **pp_b_tree );
void construct_ABC_remove_B_AC ( b_tree **pp_b_tree );
void construct_ABC_remove_C_AB ( b_tree **pp_b_tree );
...
void construct_empty ( b_tree **pp_b_tree )
{
    // b_tree_construct(pp_b_tree, (fn_comparator *)string_comparator, (fn_key_accessor *)string_key_accessor, sizeof(char*));
}

void construct_A ( b_tree **pp_b_tree )
{
    construct_empty(pp_b_tree);
    b_tree_insert(*pp_b_tree, A_element);
}

void construct_B ( b_tree **pp_b_tree )
{
    construct_empty(pp_b_tree);
    b_tree_insert(*pp_b_tree, B_element);
}

void construct_C ( b_tree **pp_b_tree )
{
    construct_empty(pp_b_tree);
    b_tree_insert(*pp_b_tree, C_element);
}

void construct_D ( b_tree **p_b_tree )
{
    construct_empty(p_b_tree);
    b_tree_insert(*p_b_tree, D_element);
}

void construct_AB ( b_tree **p_b_tree )
{
    construct_empty(p_b_tree);
    b_tree_insert(*p_b_tree, A_element);
    b_tree_insert(*p_b_tree, B_element);
}

void construct_AC ( b_tree **p_b_tree )
{
    construct_empty(p_b_tree);
    b_tree_insert(*p_b_tree, A_element);
    b_tree_insert(*p_b_tree, C_element);
}

void construct_BC ( b_tree **p_b_tree )
{
    construct_empty(p_b_tree);
    b_tree_insert(*p_b_tree, B_element);
    b_tree_insert(*p_b_tree, C_element);
...
void construct_BA ( b_tree **p_b_tree )
{
    construct_empty(p_b_tree);
    b_tree_insert(*p_b_tree, B_element);
    b_tree_insert(*p_b_tree, A_element);
...
void construct_CA ( b_tree **p_b_tree )
{
    construct_empty(p_b_tree);
    b_tree_insert(*p_b_tree, C_element);
    b_tree_insert(*p_b_tree, A_element);
...
void construct_CB ( b_tree **p_b_tree )
{
    construct_empty(p_b_tree);
    b_tree_insert(*p_b_tree, C_element);
    b_tree_insert(*p_b_tree, B_element);
...
void construct_ABC ( b_tree **p_b_tree )
{
    construct_empty(p_b_tree);
    b_tree_insert(*p_b_tree, A_element);
    b_tree_insert(*p_b_tree, B_element);
...
void construct_ACB ( b_tree **p_b_tree )
{
    construct_empty(p_b_tree);
    b_tree_insert(*p_b_tree, A_element);
    b_tree_insert(*p_b_tree, C_element);
...
void construct_BAC ( b_tree **p_b_tree )
{
    construct_empty(p_b_tree);
    b_tree_insert(*p_b_tree, B_element);
    b_tree_insert(*p_b_tree, A_element);
...
void construct_BCA ( b_tree **p_b_tree )
{
    construct_empty(p_b_tree);
    b_tree_insert(*p_b_tree, B_element);
    b_tree_insert(*p_b_tree, C_element);
...
void construct_CAB ( b_tree **p_b_tree )
{
    construct_empty(p_b_tree);
    b_tree_insert(*p_b_tree, C_element);
    b_tree_insert(*p_b_tree, A_element);
...
void construct_CBA ( b_tree **p_b_tree )
{
    construct_empty(p_b_tree);
    b_tree_insert(*p_b_tree, C_element);
    b_tree_insert(*p_b_tree, B_element);
...
void construct_ABCD ( b_tree **p_b_tree )
{
    construct_empty(p_b_tree);
    b_tree_insert(*p_b_tree, A_element);
    b_tree_insert(*p_b_tree, B_element);
...
void construct_A_remove_A_empty ( b_tree **pp_b_tree )
{
    construct_A(pp_b_tree);
    void *removed_value = NULL;
    b_tree_remove(*pp_b_tree, A_element, (const void **)&removed_value);
}

void construct_B_remove_B_empty ( b_tree **pp_b_tree )
{
    construct_B(pp_b_tree);
    void *removed_value = NULL;
    b_tree_remove(*pp_b_tree, B_element, (const void **)&removed_value);
}

void construct_C_remove_C_empty ( b_tree **pp_b_tree )
{
    construct_C(pp_b_tree);
    void *removed_value = NULL;
    b_tree_remove(*pp_b_tree, C_element, (const void **)&removed_value);
}

void construct_AB_remove_A_B ( b_tree **pp_b_tree )
{
    construct_AB(pp_b_tree);
    void *removed_value = NULL;
    b_tree_remove(*pp_b_tree, A_element, (const void **)&removed_value);
}
...
bool test_insert ( void (*constructor)(b_tree **), void *value, result_t expected )
{
    b_tree *p_b_tree = NULL;
    constructor(&p_b_tree);
    
    result_t result = (result_t)b_tree_insert(p_b_tree, value);
...
bool test_search ( void (*constructor)(b_tree **), void *key, void *expected_value, result_t expected )
{
    ...
    int ret = b_tree_search(p_b_tree, key, &found_value);
...
bool test_remove ( void (*constructor)(b_tree **), void *key, void *expected_value, result_t expected )
{
    ...
    int ret = b_tree_remove(p_b_tree, key, &removed_value);
...
bool test_size_non_zero ( void (*constructor)(b_tree **), result_t expected )
{
    ...
    // result_t result = (b_tree_size(p_b_tree) > 0) ? one : zero;
...
bool test_size ( void (*constructor)(b_tree **), size_t expected_count, result_t expected )
{
    ...
    // result_t result = (b_tree_size(p_b_tree) == expected_count) ? match : zero;
...
void test_empty_tree_scenario ( void )
{
    ...
    print_test("empty", "is empty", test_size_non_zero(construct_empty, zero));
    print_test("empty", "size 0", test_size(construct_empty, 0, match));
    print_final_summary();
}
...
void test_one_element_tree_scenario ( void )
{
    ...
    print_test("A", "is not empty", test_size_non_zero(construct_A, one));
    print_test("A", "size 1", test_size(construct_A, 1, match));
    print_final_summary();
}
...
void test_two_element_tree_scenario ( void )
{
    ...
    print_test("AB", "is not empty", test_size_non_zero(construct_AB, one));
    print_test("AB", "size 2", test_size(construct_AB, 2, match));
    print_final_summary();
}
...
void test_three_element_tree_scenario ( void )
{
    ...
    print_test("ABC", "is not empty", test_size_non_zero(construct_ABC, one));
    print_test("ABC", "size 3", test_size(construct_ABC, 3, match));
    print_final_summary();
}
...
void test_removal_scenario ( void )
{
    ...
    print_test("A->empty", "is empty", test_size_non_zero(construct_A_remove_A_empty, zero));
...
void test_search_scenario ( void )
{
    ...
    b_tree *p_b_tree = NULL;
    construct_ABC(&p_b_tree);
    
    void *found_value = NULL;
    
    // Test successful searches
    bool search_A_success = (b_tree_search(p_b_tree, A_element, &found_value) == 1) && 
                            (strcmp((char*)found_value, A_element) == 0);
    print_test("search", "find A", search_A_success);
    
    bool search_B_success = (b_tree_search(p_b_tree, B_element, &found_value) == 1) && 
                            (strcmp((char*)found_value, B_element) == 0);
    print_test("search", "find B", search_B_success);
    
    bool search_C_success = (b_tree_search(p_b_tree, C_element, &found_value) == 1) && 
                            (strcmp((char*)found_value, C_element) == 0);
    print_test("search", "find C", search_C_success);
    
    // Test unsuccessful search
    found_value = NULL;
    bool search_X_failure = (b_tree_search(p_b_tree, X_element, &found_value) == 0);
...
void test_four_element_tree_scenario ( void )
{
    ...
    print_test("ABCD", "is not empty", test_size_non_zero(construct_ABCD, one));
    print_test("ABCD", "size 4", test_size(construct_ABCD, 4, match));
    print_final_summary();
}
...
void test_balanced_tree_scenario ( void )
{
    ...
    print_test("balanced", "A count", test_size(construct_A, 1, match));
    print_test("balanced", "AB count", test_size(construct_AB, 2, match));
    print_test("balanced", "ABC count", test_size(construct_ABC, 3, match));
    print_test("balanced", "ABCD count", test_size(construct_ABCD, 4, match));
...
void test_stress_scenario ( void )
{
    ...
    for (int i = 0; i < 100 && stress_insert_success; i++) {
        ...
        if (b_tree_insert(p_stress_tree, test_value) != 1) {
    ...
    void *found_value = NULL;
    bool stress_search_success = (b_tree_search(p_stress_tree, "item_50", &found_value) == 1);
    print_test("stress", "find item_50", stress_search_success);
    
    // Count should be 100
    // bool stress_count_correct = (b_tree_size(p_stress_tree) == 100);
    // print_test("stress", "count 100", stress_count_correct);
    
    b_tree_destroy(&p_stress_tree);
    print_final_summary();
}
...
void test_traversal_scenario ( void )
{
    ...
    b_tree *p_traversal_tree = NULL;
    construct_ABC(&p_traversal_tree);
    
    traverse_counter = 0;
    memset(traverse_order, 0, sizeof(traverse_order));
    
    // b_tree_traverse_inorder(p_traversal_tree, test_traverse_callback);
    
    bool inorder_correct_order = (
        strcmp(traverse_order[0], "A") == 0 &&
        strcmp(traverse_order[1], "B") == 0 &&
        strcmp(traverse_order[2], "C") == 0
    );
    
    print_test("traversal", "in-order correct order", inorder_correct_order);
    
    b_tree_destroy(&p_traversal_tree);
    print_final_summary();
}
