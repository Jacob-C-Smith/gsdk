...
int main ( int argc, const char* argv[] )
{
    ...
    // #4 - to binary
    {
        ...
        stream_from_path(&p_stream, "resources/reflection/circular_buffer.bin");

        // reflect the circular buffer to a buffer
        circular_buffer_pack(p_stream, p_circular_buffer, string_pack);
    ...
    // #9 - from binary
    {
        ...
        circular_buffer_unpack(&p_circular_buffer, p_stream, string_unpack);
