 ...
 *
 * @file src/examples/red_black_example.c
 *
 * @author Jacob Smith
 */
...
/// logs
int checkpoint ( red_black_tree *p_red_black_tree, const char *p_event );
...
int main ( int argc, const char *argv[] )
{
    ...
    // #0 - start
    checkpoint(p_red_black_tree, "start");

    // #1 - construct a red black tree
    {

        // construct a red black tree
        red_black_tree_construct(
            &p_red_black_tree,             // result
        ...
        // checkpoint
        checkpoint(p_red_black_tree, "after construct"),
        putchar('\n');
    }
    ...
    // #2 - insert
    {
        ...
        for (size_t i = 0; i < sizeof(_values) / sizeof(*_values); i++)
            ...
            red_black_tree_insert(p_red_black_tree, &_values[i]);

        // checkpoint
        checkpoint(p_red_black_tree, "after insert"),
        putchar('\n');
    ...
    // #3 - search
    {
        ...
        // search the red black tree for 11
        red_black_tree_search(p_red_black_tree, (void *)11, (void **)&p_result);

        // checkpoint
        checkpoint(p_red_black_tree, "after search");
    ...
    // #4 - pre order
    {
        ...
        // perform a pre order traversal on the keys in the red black tree
        red_black_tree_traverse_preorder(p_red_black_tree, number_and_string_number_print), putchar('\n'),
        red_black_tree_traverse_preorder(p_red_black_tree, number_and_string_string_print), putchar('\n'),
        putchar('\n');
    }
    ...
    // #5 - post order
    {
        ...
        // perform a post order traversal on the keys in the red black tree
        red_black_tree_traverse_postorder(p_red_black_tree, number_and_string_number_print), putchar('\n'),
        red_black_tree_traverse_postorder(p_red_black_tree, number_and_string_string_print), putchar('\n'),
        putchar('\n');
    }
    ...
    // #6 - to binary
    {
        ...
        p_f = fopen("resources/reflection/red_black_tree.bin", "wb");

        // reflect the red black tree to a buffer
        file_len = red_black_tree_pack(buf, p_red_black_tree, number_and_string_pack),
        ...
        // checkpoint
        checkpoint(p_red_black_tree, "after serialize"),
        putchar('\n');
    }
    ...
    // #7 - hash 1
    {
        ...
        // hash the red black tree
        h1 = red_black_tree_hash(p_red_black_tree, number_and_string_hash);

        // print the hash
        printf("hash 1 -> 0x%llx\n", h1);

        // checkpoint
        checkpoint(p_red_black_tree, "after hash 1"),
        putchar('\n');
    }
    ...
    // #8 - remove
    {
        ...
        // checkpoint
        checkpoint(p_red_black_tree, "after remove"),
        putchar('\n');
    }
    ...
    // #9 - destroy
    {
        ...
        red_black_tree_destroy(&p_red_black_tree, NULL);

        // checkpoint
        checkpoint(p_red_black_tree, "after destroy"),
        putchar('\n');
    }
    ...
    // #10 - from binary
    {
        ...
        p_f = fopen("resources/reflection/red_black_tree.bin", "rb"),
        fread(buf, sizeof(char), file_len, p_f),
        fclose(p_f);
        
        // reflect a red black tree from the buffer
        red_black_tree_unpack(
            &p_red_black_tree, 
            buf, 
        ...
        // checkpoint
        checkpoint(p_red_black_tree, "after unpack"),
        putchar('\n');
    }
    ...
    // #11 - hash 2
    {
        ...
        // hash the red black tree
        h2 = red_black_tree_hash(p_red_black_tree, number_and_string_hash);
        ...
        // checkpoint
        checkpoint(p_red_black_tree, "after hash 2");
    }
    ...
    // #12 - for context
    {
        ...
        // perform a pre order traversal on the keys in the red black tree
        red_black_tree_forcontext(p_red_black_tree, number_and_string_accumulate, (void *) &sum);
    ...
    // #13 - destroy
    {
        ...
        // destroy the red black tree
        red_black_tree_destroy(&p_red_black_tree, default_allocator);
...
int checkpoint ( red_black_tree *p_red_black_tree, const char *p_event )
{
    ...
    // print the array
    if ( NULL == p_red_black_tree )
        log_info("#%d - Red Black tree %s: NULL\n", step, p_event);
    else
        log_info("#%d - Red Black tree %s:\n", step, p_event),
        
        putchar('('), putchar(' '),
        red_black_tree_traverse_inorder(p_red_black_tree, number_and_string_number_print),
        putchar(')'),

        printf(" -> "),
        
        putchar('('), putchar(' '),
        red_black_tree_traverse_inorder(p_red_black_tree, number_and_string_string_print),
        putchar(')'),
