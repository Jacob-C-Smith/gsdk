...
int main ( int argc, const char *argv[] )
{
    ...
    // #6 - to binary
    {
        ...
        p_f = fopen("resources/reflection/avl_tree.bin", "wb");

        // reflect the avl tree to a buffer
        file_len = avl_tree_pack(buf, p_avl_tree, number_and_string_pack),
    ...
    // #10 - from binary
    {
        ...
        p_f = fopen("resources/reflection/avl_tree.bin", "rb"),
