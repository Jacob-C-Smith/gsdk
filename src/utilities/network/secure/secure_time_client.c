...
int main ( int argc, const char *argv[] )
{
    ...
    // unpack the time string directly from the secure stream
    if ( 0 == pack_unpack(p_stream_socket, "%s", &_time) ) goto failed_to_receive;
    ...
    // error handling
    {
        ...
        // secure socket errors
        {
            ...
            failed_to_destroy_secure_socket:
                log_error("Error: Failed to destroy secure stream!\n");
                return EXIT_FAILURE;
        }
